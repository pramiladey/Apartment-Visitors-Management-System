<header class="header-desktop" style="background-color: lightcoral;">
                <div class="section__content section__content--p30" style="background-color: lightcoral;">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" name="search" action="search-visitor.php" method="post">
                                ...
                                <button class="au-btn--submit" type="submit" name="search" style="background-color: black">
...
?>   
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="images/icon/resize.jpg"/>
                                        </div>
                                        <div class="content">
