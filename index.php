...
<body class="animsition">
    <div class="page-wrapper">
        <div class="page-content--bge5" style="background-color: lightcoral;">
    ...
    echo $msg;
                        ...
                        <div class="login-form">
                            <form action="" method="post" name="login">
                                ...
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name="login" style="background-color:black;">sign in</button>
